...
router.post("/compareTeams", async (req, res, next) => {
    ...
    const totalres = await db
        .promise()
        .query(sp_insert_team_comparison); /* ignore will avoid error for duplicate keys */
...
router.post("/compare", async (req, res, next) => {
    ...
    const totalres = await db
        .promise()
        .query(sp_insert_player_comparison); /* ignore will avoid error for duplicate keys */
